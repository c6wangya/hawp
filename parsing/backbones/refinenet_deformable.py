...
class RefineNetDeform(nn.Module):
    ...
    def __init__(self, classes_num, pretrained_weights=None, cuda=True, attn=False, attn_only=False, attn_dim='', n_head=1, use_contrastive=False, share_weights=True):
        ...
        if cuda:
            ...
            DC_module = DC
            extra_args = {'attn': attn, 'attn_only': attn_only, 'attn_dim': attn_dim, 'n_head': n_head, 'use_contrastive': use_contrastive, 'share_weights': share_weights}
