...
class RefineNet(nn.Module):
    ...
    def __init__(self, classes_num, pretrained_weights=None):
        ...
        for i in range(1, 4):
            ...
            self.__setattr__("res3b{}_branch2b".format(i), nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1, bias=False))
        ...
        self.res4a_branch2b = nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        for i in range(1, 23):
            ...
            self.__setattr__("res4b{}_branch2b".format(i), nn.Conv2d(256, 256, kernel_size=3, stride=1, padding=1, bias=False))
        ...
        self.res5a_branch2b = nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False)
        ...
        for i in "bc":
            ...
            self.__setattr__("res5{}_branch2b".format(i), nn.Conv2d(512, 512, kernel_size=3, stride=1, padding=1, bias=False))
